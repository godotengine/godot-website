...
The main differences with the previous [RC 5]({{% ref "article/release-candidate-godot-3-2-3-rc-5" %}}) are C# fixes following the backport of the `csproj` and Godot.NET.Sdk changes.
