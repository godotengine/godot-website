...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.2/beta1/mono-) (C# support + all the above). You need to have MSbuild installed to use the Mono build. Relevant parts of Mono 5.18.1.3 are included in this build.
