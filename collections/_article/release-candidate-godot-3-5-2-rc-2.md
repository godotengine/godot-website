...
This release is built from commit [`66d2b7ca2`](https://github.com/godotengine/godot/commit/66d2b7ca2b29b098cc5e310a5dd7a1d4fd03231d) (see [README](https://github.com/godotengine/godot-builds/releases/3.5.2/rc2-README.txt)).
...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.5.2/rc2/mono-) (C# support + all the above). You need to have dotnet CLI or MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.182** are included in this build.
