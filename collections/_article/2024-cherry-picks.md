...
- **Editor:** [Project Manager refresh](https://godotengine.org/releases/4.3/#editor-layout-ux-improvements-project-manager)<br> Android Editor: [Binary export support](https://github.com/godotengine/godot/pull/93526)
