...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.6/beta3/mono-) (C# support + all the above). You need to have dotnet CLI or MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.182** are included in this build.
