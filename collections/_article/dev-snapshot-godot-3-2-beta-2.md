...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.2/beta2/mono-) (C# support + all the above). You need to have MSbuild installed to use the Mono build. Relevant parts of Mono 6.6.0 Preview are included in this build.
