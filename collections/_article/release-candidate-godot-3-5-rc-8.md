---
title: "Release candidate: Godot 3.5 RC 8"
excerpt: "The 3.5-stable release is just around the corner! We fixed a few more regressions for Android scoped storage and UWP accumulated input, so another Release Candidate is needed to validate those finishing touches."
categories: ["pre-release"]
author: Rémi Verschelde
image: /storage/app/uploads/public/62e/27e/c1a/62e27ec1a7b70942257259.jpg
date: 2022-07-28 12:19:15
---
...
- Android: Address remaining scoped storage regressions ([GH-63480](https://github.com/godotengine/godot/pull/63480)).
- UWP: Flush buffered input events ([GH-63341](https://github.com/godotengine/godot/pull/63341)).

[Jump to the **Downloads** section.](#downloads)

As usual, you can try it live with the [**online version of the Godot editor**](https://editor.godotengine.org/3.5.rc8/) updated for this release.
...
- Buildsystem: Refactor Linux linker options with `linker=<bfd|gold|lld|mold>` ([GH-63283](https://github.com/godotengine/godot/pull/63283)).
...
- Export: Return 0 exit code when command line export succeeds with warnings ([GH-62907](https://github.com/godotengine/godot/pull/62907)).
...
This release is built from commit [516d6b6ba](https://github.com/godotengine/godot/commit/516d6b6bad68d506391a4262ba40cbceeea8be22).
...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.5/rc8/mono-) (C# support + all the above). You need to have dotnet CLI or MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.182** are included in this build.
