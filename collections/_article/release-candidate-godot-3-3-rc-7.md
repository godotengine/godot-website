...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.3/rc7/mono-) (C# support + all the above). You need to have MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.122** are included in this build. (Note: Previous builds used Mono 6.12.0.114.)
