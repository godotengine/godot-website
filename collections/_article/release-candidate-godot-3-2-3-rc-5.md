...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.2.3/rc5/mono-) (C# support + all the above). You need to have MSBuild installed to use the Mono build. Relevant parts of Mono 6.6.0.166 are included in this build.
