...
As mentioned, this release includes close to 400 new commits, with many bug fixes, usability enhancements and documentation improvements. You can read the [complete changelog](https://github.com/godotengine/godot-builds/releases/3.1.2/rc1-Godot_v3.1.2-rc1_changelog.txt) for details. Below are a few selected highlights:
...
- Mono version: [[HTTPS mirror](https://github.com/godotengine/godot-builds/releases/3.1.2/rc1-mono)]
