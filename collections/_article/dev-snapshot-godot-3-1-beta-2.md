...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.1/beta2-mono) (C# support + all the above). You need to have Nuget and MSbuild installed to use the Mono build. However, this build no longer mandates a specific Mono SDK version.
