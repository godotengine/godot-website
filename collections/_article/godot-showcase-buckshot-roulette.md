---
title: "Godot Showcase - Buckshot Roulette"
excerpt: "Mike Klubnika tells us about his experience working on Buckshot Roulette."
categories: ["showcase"]
...
![](/storage/blog/godot-showcase-buckshot-roulette/split.webp)
...
It's very fast, even in bigger projects. My favourite feature has to be the AnimationPlayer, which is very powerful and quick to set up. Coming from C#, I also liked GDscript once I got used to it. I think it's a very nice programming language.
...
[Mike Klubnika](https://mikeklubnika.com/)'s games including *Buckshot Roulette* and *s.p.l.i.t* are available on [Steam](https://store.steampowered.com/developer/mikeklubnika). You can also join his [Discord server](https://discord.gg/jDGePvU3Z5).
