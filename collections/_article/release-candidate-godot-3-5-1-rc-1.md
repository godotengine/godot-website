...
This release is built from commit [`293c3844b`](https://github.com/godotengine/godot/commit/293c3844b3424b4a64d6245f99145266101a146f) (see [README](https://github.com/godotengine/godot-builds/releases/3.5.1/rc1-README.txt)).
...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.5.1/rc1/mono-) (C# support + all the above). You need to have dotnet CLI or MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.182** are included in this build.
