...
This release is built from commit [`69585b051`](https://github.com/godotengine/godot/commit/69585b051629ec9f8be63a1b5212510f98b81e6f) (see [README](https://github.com/godotengine/godot-builds/releases/3.4.1/rc3-README.txt)).
...
- [Mono build](https://github.com/godotengine/godot-builds/releases/3.4.1/rc3/mono-) (C# support + all the above). You need to have dotnet CLI or MSBuild installed to use the Mono build. Relevant parts of Mono **6.12.0.158** are included in this build.
